...
# (스크립트가 프로젝트 루트에 있으므로 Path(__file__).parent/data/trade_dashboard 로 해석)
# 팀 원본처럼 스크립트 옆에 쓰고 싶으면 TRADE_CSV_OUT_DIR 로 override.
_DEFAULT_OUT_DIR = Path(__file__).parent / "data" / "trade_dashboard"
OUT_DIR = Path(os.environ.get("TRADE_CSV_OUT_DIR", _DEFAULT_OUT_DIR))
OUT_DIR.mkdir(parents=True, exist_ok=True)

HISTORY_PATH = OUT_DIR / "trade_history_long.csv"
COMPANY_HISTORY_PATH = OUT_DIR / "company_trade_history_long.csv"
DECADE_HISTORY_PATH = OUT_DIR / "trade_history_decade_long.csv"
