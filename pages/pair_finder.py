...
# ── 데이터 로딩 ───────────────────────────────────────
SECTOR_VERSION = 10  # 네이버 79업종 + WICS 보완
...
**네이버 금융 79개 업종 분류**를 기본으로 사용하며, 네이버에서 "기타"로 분류된 종목은
**WICS(WISE Industry Classification Standard) GICS 11개 섹터**로 보완합니다.

> 반도체와반도체장비 · 전기제품 · 전자장비와기기 · 디스플레이장비및부품 · 소프트웨어 ·
> IT서비스 · 화장품 · 제약 · 생물공학 · 화학 · 기계 · 자동차부품 · 건설 · 철강 ·
> 식품 · 방송과엔터테인먼트 · 우주항공과국방 · 에너지장비및서비스 · 금융 등 79개 업종
