...
KRX 표준산업분류(KSIC) `Industry` 필드를 기반으로 **18개 대분류 섹터**로 매핑합니다.

> 반도체/전자 · IT/소프트웨어 · 자동차 · 조선/기계 · 방산/항공 · 철강/금속 · 화학 ·
> 바이오/제약 · 금융 · 건설 · 유통/소비재 · 운송/물류 · 에너지 · 미디어/엔터 ·
> 통신서비스 · 섬유/의복 · 부동산 · 플라스틱/고무 · 기타
