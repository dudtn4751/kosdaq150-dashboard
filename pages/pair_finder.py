...
SECTOR_MAP = [
    # 2차전지/신에너지 — 배터리, 연료전지 등 (반도체·전자와 분리)
    ("2차전지/신에너지", ["일차전지 및 이차전지", "연료용 가스"]),
    # 반도체 — 순수 반도체 설계/제조/장비
    ("반도체",         ["반도체"]),
    # 전자/IT부품 — 전자부품, PCB, 디스플레이, 통신장비
    ("전자/IT부품",     ["전자부품", "통신 및 방송 장비", "디스플레이", "영상 및 음향기기"]),
    # 전력기기 — 전동기, 변압기, 전선, 중전기
...
TICKER_SECTOR_OVERRIDE = {
    "322000": "에너지/유틸리티",    # HD현대에너지솔루션 → 태양광
    "336260": "2차전지/신에너지",   # 두산퓨얼셀 → 수소연료전지
    "272210": "방산/항공",        # 한화시스템 → 방산 레이더/SAR
    "298040": "전력기기",         # 효성중공업 → 변압기/중전기
    "160190": "전력기기",         # 하이젠알앤엠 → 변압기 부품
    "032820": "전력기기",         # 우리기술 → 전력 계통
    "131970": "반도체",          # 두산테스나 → 반도체 테스트
    "271940": "2차전지/신에너지",   # 일진하이솔루스 → 수소탱크
}
...
> 반도체 · 전자/IT부품 · 전력기기 · 2차전지/신에너지 · IT/소프트웨어 · 통신 ·
