...
short_screener = st.Page("pages/short_screener.py", title="숏 후보 스크리너", url_path="short_screener")
...
nav = st.navigation(
    {
        ...
        "종목 스크리닝": [epsrev_grid, epsrev_secdetail, epsrev_codetail, epsrev_pair, short_screener],
